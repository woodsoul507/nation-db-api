...
public class ICountryStatsJpaRepositoryTest {

    @Autowired
    private ICountryStatsJpaRepository repository;
    ...
    public void countCountryStats() {
        ...
        assertEquals(9514, repository.count());
    }
}
